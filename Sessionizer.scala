...
object Sessionizer {
  ...
  def main(args: Array[String]) {
    ...
    stateSnapshotStream.foreachRDD((rdd, time) => {
      ...
      // toDF can take a list of column names, and if the number of columns matches what's in your RDD,
      // it just works without having to use an intermediate case class to define your records.
